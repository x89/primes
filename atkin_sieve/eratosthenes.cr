...
runs = 1
Benchmark.bm do |x|
  x.report { runs.times do 100.to_u64.eratosthenes; end }
  x.report { runs.times do 10000.to_u64.eratosthenes; end }
  x.report { runs.times do 1000000.to_u64.eratosthenes; end }
  x.report { runs.times do 10000000.to_u64.eratosthenes; end }
end
